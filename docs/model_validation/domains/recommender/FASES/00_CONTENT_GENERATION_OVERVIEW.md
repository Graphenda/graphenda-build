...
Gerar todo o conteudo do dominio "Recommender Systems" para o ModelRiskLab.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/20-recommender.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo: MF, NCF, content-based, Wide&Deep, eval, fairness, plots  | F3           |
...
- [ ] 7 arquivos de codigo (MF, NCF, content-based, Wide&Deep, offline eval, coverage/fairness, plots)
- [ ] Template de relatorio + exemplo com MF vs NCF para e-commerce
