...
Gerar todo o conteudo do dominio "Reinforcement Learning" para o ModelRiskLab.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/12-reinforcement-learning.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo: DQN, PPO, bandits, SAC, OPE, reproducibility, plots       | F3           |
...
├── news/
│   ├── rl-*.md                ← F2
├── code-examples/reinforcement-learning/
│   ├── modeling/              ← F4
│   ├── validation/            ← F4
│   └── visualization/         ← F4
└── report-templates/reinforcement-learning/
    ├── template.md            ← F5
    └── example.md             ← F5
```
...
- [ ] 7 arquivos de codigo funcional (DQN, PPO, bandits, SAC, OPE, reproducibility, plots)
- [ ] Template de relatorio de validacao completo
- [ ] Exemplo de relatorio com DQN CartPole
