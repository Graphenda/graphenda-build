...
Gerar todo o conteudo do dominio "Deep Learning — Sequential" para o ModelRiskLab.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/15-deep-learning-sequential.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo: LSTM, GRU, Transformer, TFT, baselines, walk-forward, att | F3           |
...
├── guides/deep-learning-sequential/
│   ├── papers.md              ← F1
│   ├── overview.md            ← F3
│   ├── models.md              ← F3
│   ├── validation.md          ← F3
...
├── news/
│   ├── dl-sequential-*.md     ← F2
├── code-examples/deep-learning-sequential/
│   ├── modeling/              ← F4
│   ├── validation/            ← F4
│   └── visualization/         ← F4
└── report-templates/deep-learning-sequential/
    ├── template.md            ← F5
    └── example.md             ← F5
```
...
- [ ] 8 arquivos de codigo (LSTM, GRU, Transformer, TFT, baselines, walk-forward, attention, plots)
- [ ] Template de relatorio + exemplo com LSTM/TFT energy forecasting
