...
Gerar todo o conteudo do dominio "Panel Data Models" para o ModelRiskLab,
incluindo papers academicos, noticias, guias explicativos, codigo de exemplo
e templates de relatorio de validacao.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/02-panel-data.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo de exemplo: FE, RE, GMM, diagnosticos, plots    | F3           |
...
│   └── pitfalls.md            ← F3
├── news/
│   ├── panel-data-*.md        ← F2 (multiplos artigos)
├── code-examples/panel-data/
│   ├── modeling/              ← F4
│   ├── validation/            ← F4
│   └── visualization/         ← F4
└── report-templates/panel-data/
    ├── template.md            ← F5
    └── example.md             ← F5
```
...
- [ ] 7 arquivos de codigo funcional (FE, RE, GMM, pooled, hausman, diagnostics, plots)
- [ ] Template de relatorio de validacao completo
- [ ] Exemplo de relatorio preenchido com dados reais (Grunfeld ou similar)
