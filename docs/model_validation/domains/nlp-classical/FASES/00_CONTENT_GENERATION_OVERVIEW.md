...
Gerar todo o conteudo do dominio "NLP Classical" para o ModelRiskLab.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/16-nlp-classical.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo: TF-IDF, LDA, NER/CRF, sentiment, eval, coherence, plots | F3           |
...
├── news/
│   ├── nlp-classical-*.md     ← F2
├── code-examples/nlp-classical/
│   ├── modeling/              ← F4
│   ├── validation/            ← F4
│   └── visualization/         ← F4
└── report-templates/nlp-classical/
    ├── template.md            ← F5
    └── example.md             ← F5
```
...
- [ ] 7 arquivos de codigo (TF-IDF classif, LDA, NER/CRF, sentiment, text eval, coherence, plots)
- [ ] Template de relatorio + exemplo com TF-IDF+SVM classificacao de reclamacoes
