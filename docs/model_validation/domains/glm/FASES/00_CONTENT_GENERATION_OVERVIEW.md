...
Gerar todo o conteudo do dominio "Generalized Linear Models" para o ModelRiskLab,
incluindo papers academicos, noticias, guias explicativos, codigo de exemplo
e templates de relatorio de validacao.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/04-glm.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo de exemplo: logistica, Poisson, NB, Gamma, GAM, diag.    | F3           |
...
│   └── pitfalls.md            ← F3
├── news/
│   ├── glm-*.md               ← F2 (multiplos artigos)
├── code-examples/glm/
│   ├── modeling/              ← F4
│   ├── validation/            ← F4
│   └── visualization/         ← F4
└── report-templates/glm/
    ├── template.md            ← F5
    └── example.md             ← F5
```
...
- [ ] 7 arquivos de codigo funcional (logistica, Poisson/NB, Gamma/Tweedie, GAM, calibration, deviance, plots)
- [ ] Template de relatorio de validacao completo
- [ ] Exemplo de relatorio preenchido com German Credit Data (logistica)
