...
Gerar todo o conteudo do dominio "Survival Models" para o ModelRiskLab,
incluindo papers academicos, noticias, guias explicativos, codigo de exemplo
e templates de relatorio de validacao.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/05-survival.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo de exemplo: KM, Cox, AFT, competing risks, diagnosticos | F3          |
...
│   └── pitfalls.md            ← F3
├── news/
│   ├── survival-*.md          ← F2 (multiplos artigos)
├── code-examples/survival/
│   ├── modeling/              ← F4
│   ├── validation/            ← F4
│   └── visualization/         ← F4
└── report-templates/survival/
    ├── template.md            ← F5
    └── example.md             ← F5
```
...
- [ ] 7 arquivos de codigo funcional (KM, Cox, AFT, competing risks, PH test, concordance, plots)
- [ ] Template de relatorio de validacao completo
- [ ] Exemplo de relatorio preenchido com lung cancer dataset
