...
Gerar todo o conteudo do dominio "Bayesian Models" para o ModelRiskLab.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/11-bayesian.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo: regression, hierarchical, GP, classification, BSTS, MCMC, plots | F3           |
...
├── news/
│   ├── bayesian-*.md          ← F2
├── code-examples/bayesian/
│   ├── modeling/              ← F4
│   ├── validation/            ← F4
│   └── visualization/         ← F4
└── report-templates/bayesian/
    ├── template.md            ← F5
    └── example.md             ← F5
```
...
- [ ] 8 arquivos de codigo funcional (regression, hierarchical, GP, classification, BSTS, MCMC diag, model comparison, plots)
- [ ] Template de relatorio de validacao completo
- [ ] Exemplo de relatorio com Radon dataset (modelo hierarquico)
