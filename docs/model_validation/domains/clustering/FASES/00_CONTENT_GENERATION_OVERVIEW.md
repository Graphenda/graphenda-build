...
Gerar todo o conteudo do dominio "Clustering Models" para o ModelRiskLab,
incluindo papers academicos, noticias, guias explicativos, codigo de exemplo
e templates de relatorio de validacao.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/09-clustering.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo: K-Means, DBSCAN, GMM, hierarquico, evaluation, profiling    | F3           |
...
│   └── pitfalls.md            ← F3
├── news/
│   ├── clustering-*.md        ← F2 (multiplos artigos)
├── code-examples/clustering/
│   ├── modeling/              ← F4
│   ├── validation/            ← F4
│   └── visualization/         ← F4
└── report-templates/clustering/
    ├── template.md            ← F5
    └── example.md             ← F5
```
...
- [ ] 7 arquivos de codigo funcional (K-Means, DBSCAN/OPTICS, GMM, hierarquico/spectral, evaluation, profiling, plots)
- [ ] Template de relatorio de validacao completo
- [ ] Exemplo de relatorio com Mall Customers (segmentacao)
