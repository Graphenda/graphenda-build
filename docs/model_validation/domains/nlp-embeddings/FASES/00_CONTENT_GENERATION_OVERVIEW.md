...
Gerar todo o conteudo do dominio "NLP Embeddings" para o ModelRiskLab.

## Referencia

- Especificacao do dominio: `/home/guhaase/projetos/Graphenda/build/docs/model_validation/domains/17-nlp-embeddings.md`
...
| PENDENTE | CONTENT_GEN_F4.md     | Codigo: Word2Vec, BERT, Sentence-BERT, BERTimbau, bias, quality, viz | F3           |
...
│   └── pitfalls.md            ← F3
├── news/                      ← F2
├── code-examples/nlp-embeddings/
│   ├── modeling/              ← F4
│   ├── validation/            ← F4
│   └── visualization/         ← F4
└── report-templates/nlp-embeddings/
    ├── template.md            ← F5
    └── example.md             ← F5
```
...
- [ ] 7 arquivos de codigo (Word2Vec, BERT, Sentence-BERT, BERTimbau, bias detection, embedding quality, plots)
- [ ] Template de relatorio + exemplo com BERTimbau sentimento PT-BR
